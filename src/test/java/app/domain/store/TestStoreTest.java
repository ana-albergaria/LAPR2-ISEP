...
//========== US16 ================
    ...
    //Test 6
    @Test
    public void testGetNumTestsWaitingForResultsInterval() throws BarcodeException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        TestStore testStore = new TestStore();
        Client client = new Client("1234567890123456", "1234567890", d1, "Male", "1234567890", "alex@gmail.com", "Alex", "12345678601");
        ...
        Date beginningDay = new Date(2020, Calendar.JANUARY, 16, 0, 0, 0);
        Date endingDay = new Date(2020, Calendar.JANUARY, 30, 23, 59, 59);

        int expectedResult = 2;
        int obtainedResult = testStore.getNumTestsWaitingForResultsInterval(beginningDay, endingDay);
    ...
    //Test 7
    @Test
    public void testGetNumTestsWaitingForDiagnosisDay() throws BarcodeException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        TestStore testStore = new TestStore();
        Client client = new Client("1234567890123456", "1234567890", d1, "Male", "1234567890", "alex@gmail.com", "Alex", "12345678601");
        ...
        int expectedResult = 1;
        int obtainedResult = testStore.getNumTestsWaitingForDiagnosisDay(day);
    ...
    //Test 8
    @Test
    public void testGetNumTestsWaitingForDiagnosisInterval() throws BarcodeException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        TestStore testStore = new TestStore();
        Client client = new Client("1234567890123456", "1234567890", d1, "Male", "1234567890", "alex@gmail.com", "Alex", "12345678601");
        ...
        Report report4 = new Report("Everything is well.");
        test1.addReport(report1);
        Date date4r = new Date(2020,Calendar.JANUARY,25,19,0,0);
        test1.setDateOfDiagnosis(date4r);
        ...
        int expectedResult = 1;
        int obtainedResult = testStore.getNumTestsWaitingForDiagnosisInterval(beginningDay, endingDay);
