...
|                                                                                                         |	...instantiating a new Sample?						                                                                      | TestStore                          | Creator (Rule 1): in the DM, Test collects Samples. For LC reasons, it was created a TestStore for which class Test's responsabilities were assigned, therefore it knows the samples.     |
...
| Step 3: selects test  		                                                                          |	...saving the selected test?						                                                                      | Sample                             | IE: in the DM, Sample (object created in Step 1) is associated to a certain test.                                                                                                         |
| Step 4: asks the number of samples to collect                                                    		  |	...asking the user for this data?						                                                                  | RecordSampleUI                     | IE: responsible for user interaction.                                                                                                                                                     |
