...
| Step 4: Shows all parameters associated with tt category and request to select one | ...knowing which category of parameters to be shown?                    | TestType        | IE: The test type selected in step 5 has it's category of parameters|              
