...
>
>Q2: Will the CSV files always have the same format as the ones available on moodle?
>
>A2: Yes. But we can have more categories and parameters for each type of test.
>
>Q2 Link [here](https://moodle.isep.ipp.pt/mod/forum/discuss.php?d=8883).
