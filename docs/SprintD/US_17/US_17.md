...
|:-------------  |:--------------------- |:------------|:----------------------------  |
| Step 1: asks to import clinical tests from a CSV file.                               |...Instantiating a new Test?                                                    | CreateTestController               | Controller: The system already has a Controller for this use case, promoting the reuse of it.|
|                                                                                      |...Instantiating a new Client(if needed)?                                       | RegisterClientController           | Controller: The system already has a Controller for this use case, promoting the reuse of it.|
...
| Step 6: informs operation success                                                    | ... informing operation success?                                               | ImportTestUI                        |IE: responsible for user interaction|   
